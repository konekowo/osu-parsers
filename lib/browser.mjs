  ...
  static _handleCommand(line) {
    ...
    switch (type) {
      ...
      case CommandType.VectorScale: {
        ...
        (_c = this._timelineGroup) === null || _c === void 0 ? void 0 : _c.vectorScale.add(type, easing, startTime, endTime, new Vector2(startX, startY), new Vector2(endX, endY));
      ...
      case CommandType.Movement: {
        ...
        (_e = this._timelineGroup) === null || _e === void 0 ? void 0 : _e.x.add(CommandType.MovementX, easing, startTime, endTime, startX, endX);
        (_f = this._timelineGroup) === null || _f === void 0 ? void 0 : _f.y.add(CommandType.MovementY, easing, startTime, endTime, startY, endY);
      ...
      case CommandType.Color: {
        ...
        (_j = this._timelineGroup) === null || _j === void 0 ? void 0 : _j.color.add(type, easing, startTime, endTime, new Color4(startRed, startGreen, startBlue, 1), new Color4(endRed, endGreen, endBlue, 1));
    ...
    if (frames) {
      ...
      frames.forEach((frame) => {
        ...
        const encodedData = [
          ...
          (_c = legacyFrame === null || legacyFrame === void 0 ? void 0 : legacyFrame.buttonState) !== null && _c !== void 0 ? _c : ReplayButtonState.None,
        ];
...
class ReplayDecoder {
  ...
  static handleLifeBarFrame(frameData) {
    return new LifeBarFrame(Parsing.parseInt(frameData[0]), Parsing.parseFloat(frameData[1]));
  }
  ...
  static handleReplayFrame(frameData) {
    return new LegacyReplayFrame(0.0, Parsing.parseFloat(frameData[0]), new Vector2(Parsing.parseFloat(frameData[1], Parsing.MAX_COORDINATE_VALUE), Parsing.parseFloat(frameData[2], Parsing.MAX_COORDINATE_VALUE)), Parsing.parseInt(frameData[3]));
  }
}
